...
const ScenarioCardSkeleton = () => (
    <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden flex flex-col animate-pulse">
        <div className="p-4 sm:p-6 flex-1 flex flex-col">
            ...
            <div className="border-t border-gray-200 pt-3 mb-4 space-y-1">
...
const ScenarioCard = ({ 
    ...
    onTogglePublish: (id: string, currentPublic: boolean) => void;
    onDelete: (id: string) => void;
}) => (
    <div className="bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col">
        <div className="p-4 sm:p-6 flex-1 flex flex-col">
            <div className="flex items-start justify-between gap-2 mb-3">
            ...
            <div className="flex gap-2">
                ...
                {isUserScenario && (
                    <>
                        ...
                        <button 
                            onClick={() => onTogglePublish(scenario._id, scenario.public)}
                            className="px-4 py-2.5 bg-gray-100 text-gray-700 font-semibold rounded-xl hover:bg-gray-200 transition"
...
export default function Scenarios(){
    ...
    const handleEditScenario = (scenarioId: string) => {
        navigate(`/dashboard/scenario-creator/${scenarioId}`);
    };
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
                                            {allScenarios.map((scenario) => (
                                                <ScenarioCard
                                                    ...
                                                    onTogglePublish={handleTogglePublishScenario}
