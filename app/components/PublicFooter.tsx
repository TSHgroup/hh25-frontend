...
const PublicFooter: React.FC = () => {
    ...
    return(
        <footer className="mt-auto w-full bg-gradient-to-br from-gray-900 to-gray-800 text-gray-300">
            <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
                <div className="grid md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        <h3 className="text-white font-bold text-lg mb-6">Produkt</h3>
                        <ul className="space-y-4">
                            ...
                            <li>
                                <Link to="/scenarios" className="text-gray-400 hover:text-white transition-colors duration-300">
                                    Scenariusze
                                </Link>
                            </li>
                            <li>
                ...
                <div className="pt-8 border-t border-gray-700">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex items-center gap-2 text-sm">
                            ...
                            <a href="https://hackheroes.pl" target="_blank" rel="noopener noreferrer" className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 hover:from-blue-500 hover:to-purple-600 transition-all duration-300">
                                TSH HackHeroes 2025
                            </a>
                        </div>
